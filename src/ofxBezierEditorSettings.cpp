...
: curveVertices(curveVertices), controlPoint1(controlPoint1), controlPoint2(controlPoint2), curveVerticesGeo(curveVerticesGeo), controlPoint1Geo(controlPoint1Geo), controlPoint2Geo(controlPoint2Geo) {
