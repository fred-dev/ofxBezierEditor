...
#ifdef GEO_LINE
    shared_ptr<vector<draggableVertex>> curveVerticesGeo = make_shared<vector<draggableVertex>>();
    shared_ptr<vector<draggableVertex>> controlPoint1Geo = make_shared<vector<draggableVertex>>();
    shared_ptr<vector<draggableVertex>> controlPoint2Geo = make_shared<vector<draggableVertex>>();
#endif
